...
export const Task = memo((props: PropsType) => {
        ...
        const onChangeCheckHandler = (e: ChangeEvent<HTMLInputElement>) => props.changeTaskStatus(props.id, props.toDoListId, e.currentTarget.checked)
            ...
            <div className={s.tasksBox}
                ...
                <div className={s.mainBoxTasks}>
                    ...
                    <EditableLabel title={props.title}
                                   ...
                                   className={!props.isDone ? s.textTrue : s.textFalse}/>
